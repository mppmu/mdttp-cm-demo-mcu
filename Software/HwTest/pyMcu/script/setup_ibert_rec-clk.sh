...
#   IC82, free-running mode, OUT: 240 MHz
#   -> FELIX IBERT rxoutclock: 120 MHz
#   -> Multiplexer for recovered LHC clock (IC57)
#   -> IC56, IN3: 120 MHz, OUT: 40 MHz
#   -> IC83, IN2:  40 MHz, OUT: 40 MHz
#       +-> IC84, IN0: 40 MHz, OUT: 320 MHz -> KU15P FE IBERT reference clock
#       +-> IC85, IN0: 40 MHz, OUT: 320 MHz -> ZU11EG FE IBERT reference clock
#
...
echo "Program the clock synthesizer chip ICi83 (Si5342A) to generate a 40 MHz LHC clock from the 40 MHz LHC clock on its input 2."
